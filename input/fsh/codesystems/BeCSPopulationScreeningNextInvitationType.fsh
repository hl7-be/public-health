...
* ^concept[=].display = "Next invitation will be around the indicated date"
...
* ^concept[=].display = "Exclusion from invitation"
* ^concept[=].designation[+].language = #en
...
* ^concept[=].display = "No invitations because of refusal. For more information about this investigation, contact your GP."
* ^concept[=].designation[+].language = #en
...
* ^concept[=].display = "The date for a new investigation depends on the current one."
* ^concept[=].designation[+].language = #en
...
* ^concept[=].display = "Insufficient information to determine the next invitation date."
* ^concept[=].designation[+].language = #en
