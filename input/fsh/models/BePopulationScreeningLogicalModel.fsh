...
* screeningYear 1..1 string "The calendar year of the screening." """The year the screening process/episode for the given screenig. If the patient participated, the participation year is taken. If the patient didn't participate, the calendar year of the invitation is taken. 
...
* invitation 0..1 BackboneElement "The appointment details of the invitation." "An invitation is not mandatory, in some cases a patient can participate for a screening without an invitation."
  ...
  * time 1..1 time "The time for the screening if there is a proposed appointment. This is the case for breast cancer screening."
...
* participation 0..1 BackboneElement "The participation details." "A participation is not mandatory. A patient can choose not to participate for a screening."
  ...
  * result 0..1 CodeableConcept "If the result of participation in the population based screening" "Notify the patient if the result was abnormal/positive or normal/negative, (Afwijkend/Niet afwijkend)"
  * followup 0..1 BackboneElement "Details of proposed actions for the patient after the screening concluded." "This data acts purely as info for the patient to inform the patient of proposed actions and should not be followed up by the screening authority."
    ...
    * advice 0..1 string "Indication what other examinations/steps the patient should taken."
